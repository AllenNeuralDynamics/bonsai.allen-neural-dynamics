...
{
    /// <summary>
    /// Represents an operator that instructs a <see cref="ZaberDevice"/> to park, or unpark, a selected axis or device.
    /// </summary>
    [Description("Stops an axis of a Zaber manipulator.")]
    public class Park : Sink<bool>
    {
        /// <summary>
        ...
        /// <summary>
        /// Parks (True), or Unparks(False) a specified axis or device when a value is received.
        /// </summary>
        /// <returns>
        /// Returns the original bool input sequence.
        /// </returns>
            ...
            return Observable.Using(
                ...
                (connection, cancellationToken) =>
                {
                    return Task.FromResult(source.Do(input =>
                    {
                        ...
                        {
                            if (input){
                                connection.Device.Park(Device, Axis);
                            }
                            else
                            {
                                connection.Device.Unpark(Device, Axis);
                            }
                        }
                    }));
                });
